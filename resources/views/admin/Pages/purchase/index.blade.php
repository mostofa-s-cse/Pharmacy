                    ...
                    <div class="modal-content">
                        ...
                        <form method="post" enctype="multipart/form-data" id="add_Purchase_form" autocomplete="off">
                            ...
                            <div class="row">
                              ...
                              <div class="col-lg-4">
                                <div class="form-group">
                                  ...
                                  <select class="select2 form-select form-control" name="supplier" id="show_get_Purchase"> 
                          ...
                          <div class="submit-section">
                            <button class="btn btn-primary submit-btn" id="add_Purchase_btn" type="submit" >Submit</button>
                          </div>
                        </form>
                        </div>
                    </div>
