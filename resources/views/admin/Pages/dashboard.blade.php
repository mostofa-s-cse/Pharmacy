                    ...
                    <div class="card-body">
                        ...
                        <div class="progress mb-4">
                            ...
                            <div class="progress-bar bg-danger" role="progressbar" style="width: 26%"
                                 aria-valuenow="14" aria-valuemin="0" aria-valuemax="100">21%
                            </div>
                            <div class="progress-bar bg-info" role="progressbar" style="width: 10%"
                                 aria-valuenow="14" aria-valuemin="0" aria-valuemax="100">10%
                            </div>
                        </div>
                        <div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="leave-info-box">
                            <div class="media d-flex align-items-center">
                                <a href="profile.html" class="avatar"><img alt src="images/user.jpg"></a>
                        ...
                        <div class="table-responsive">
                            <table class="table custom-table mb-0">
                                    ...
                                    <td>
                                        <h2 class="table-avatar">
                                            <a href="#" class="avatar"><img alt
                                                                            src="images/avatar-19.jpg"></a>
                                            <a href="client-profile.html">Barry Cuda <span>CEO</span></a>
                                        </h2>
                                    </td>
                                    <td><a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                                           data-cfemail="7c1e1d0e0e051f09181d3c19041d110c1019521f1311">[email protected]</a>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td><a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                                           data-cfemail="e09492859393819785988c8592a08598818d908c85ce838f8d">[email protected]</a>
                                    </td>
                                    <td>
                                        <div class="dropdown action-label">
                                            <a class="btn btn-white btn-sm btn-rounded dropdown-toggle"
                                    ...
                                    <td>
                                        <h2 class="table-avatar">
                                            <a href="client-profile.html" class="avatar"><img alt
                                                                                              src="images/avatar-07.jpg"></a>
                                            <a href="client-profile.html">Ruby Bartlett <span>CEO</span></a>
                                        </h2>
                                    </td>
                                    <td><a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                                           data-cfemail="d8aaadbaa1bab9aaacb4bdacac98bda0b9b5a8b4bdf6bbb7b5">[email protected]</a>
                                    </td>
                                    <td>
                                        <div class="dropdown action-label">
                                            <a class="btn btn-white btn-sm btn-rounded dropdown-toggle"
                                ...
                                <tr>
                                    <td>
                                        <h2 class="table-avatar">
                                            <a href="client-profile.html" class="avatar"><img alt
                                                                                              src="images/avatar-06.jpg"></a>
                                            <a href="client-profile.html"> Misty Tison <span>CEO</span></a>
                                        </h2>
                                    </td>
                                    <td><a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                                           data-cfemail="731e1a00070a071a001c1d33160b121e031f165d101c1e">[email protected]</a>
                                    </td>
                                    <td>
                                        <div class="dropdown action-label">
                                            <a class="btn btn-white btn-sm btn-rounded dropdown-toggle"
                                ...
                                <tr>
                                    <td>
                                        <h2 class="table-avatar">
                                            <a href="client-profile.html" class="avatar"><img alt
                                                                                              src="images/avatar-14.jpg"></a>
                                            <a href="client-profile.html"> Daniel Deacon
                                                <span>CEO</span></a>
                                        </h2>
                                    </td>
                                    <td><a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                                           data-cfemail="94f0f5fafdf1f8f0f1f5f7fbfad4f1ecf5f9e4f8f1baf7fbf9">[email protected]</a>
                                    </td>
                                    <td>
                                        <div class="dropdown action-label">
                                            <a class="btn btn-white btn-sm btn-rounded dropdown-toggle"
